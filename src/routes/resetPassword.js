...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setMessage(response.data?.message || "Reset failed. Try again.");
        setSuccess(false);
      }
    } catch (err) {
  ...
  return (
    <div className="resetPsswrd">
      <h2>Reset Password</h2>
      <div className="containerrs">
        <div className="leftrs">
          <form className="formrs" onSubmit={handleSubmit}>
            <div className="input-blockrs">
              <input
                className="input"
                type="password"
                id="email"
            ...
            <div className="input-blockrs">
              <button className="btnrs" type="submit">
                Reset Password
              </button>
            </div>
            {message && <p className="msgrp">{message}</p>}
          </form>
        </div>
